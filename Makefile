##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.11.2] date: [Sun Jun 12 17:43:49 CST 2022] 
##########################################################################################################################
...
down:
	openocd -f stlink-v2.cfg -f stm32f0x.cfg -c "init" -c "reset halt" -c \
	"flash write_image erase build/BLDC_NOHALL.hex" -c reset -c shutdown
ocd:
